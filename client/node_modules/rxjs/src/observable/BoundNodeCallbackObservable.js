...
DispatchState();
{
    ...
    if (!subject) {
        ...
        innerArgs: any[];
        {
            ...
            var err = innerArgs.shift();
            if (err) {
                self_1.add(scheduler.schedule(dispatchError, 0, { err: err, subject: subject_2 }));
            }
            else if (selector) {
        ...
        if (result === errorObject_1.errorObject) {
            self_1.add(scheduler.schedule(dispatchError, 0, { err: errorObject_1.errorObject.e, subject: subject }));
        }
    }
